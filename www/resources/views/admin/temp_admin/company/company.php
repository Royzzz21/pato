...
while($data=mysql_fetch_array($r)){
	...
	<tr>
		...
		<td class=c2>
			...
			<span class="button small bp"><a href="company_loca.php?company_idx=<?=$data[idx]?>&a=mod_form&then_go=<?=urlencode($_SERVER[REQUEST_URI])?>">사업부</a></span>
			...
			<span class="button small bp"><a href="company_posi.php?company_idx=<?=$data[idx]?>&a=mod_form&then_go=<?=urlencode($_SERVER[REQUEST_URI])?>">직위</a></span>
