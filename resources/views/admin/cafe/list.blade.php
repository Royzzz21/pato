                          ...
                          foreach($list_info as $row){
                             $reg_time=$row->ts; // 등록시각
                              ...
                              ?>
                                  ...
                                  <tr>
                                      <td style="font-size:13px;background-color:#FFFFFF;padding:10px;font-weight:bold;"><a href="#<?=$req_path2?>?a=view&idx=<?=$row->id?>&page=<?=$page?>" style="color:#17002f"><?=$row->cafe_name?></a></td>
                                      <td style="font-size:12px;background-color:#FFFFFF;padding:10px;font-weight:bold;border-top:1px solid white;"><?=$row->aid;?></td>
                                      <td style="font-size:12px;background-color:#FFFFFF;padding:10px;font-weight:bold;border-top:1px solid white;"><?=$row->user_id;?></td>
                                      <td style="font-size:12px;background-color:#FFFFFF;padding:10px;font-weight:bold;border-top:1px solid white;"><?=$row->cafe_memo;?></td>
